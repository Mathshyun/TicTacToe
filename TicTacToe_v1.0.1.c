...
void settings() {
	...
	while (1) {
		...
		printf("                                                                                                    \n");
		printf("                                                                                                    \n");
		printf("                                     %s AI 대기 시간 : %s %s                                     \n", (selected == 0) ? "▶" : "  ", (AIinterval == 1000) ? " 1초" : (AIinterval == 500) ? ".5초" : "즉시", (selected == 0) ? "◀" : "  ");
		printf("                                            %s 나가기 %s                                            \n", (selected == 1) ? "▶" : "  ", (selected == 1) ? "◀" : "  ");
		printf("                                                                                                    \n");
		printf("                                                                                                    \n");
		printf("                                                                                                    \n");
		...
		case 13:
			switch (selected) {
			case 0:
				if (AIinterval == 0) AIinterval = 1000;
				else AIinterval -= 500;
				break;
			case 1:
				return;
